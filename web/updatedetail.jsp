    ...
    int ans=0,num=0;
        ...
        if(email!=null &&  password!=null)
        {
            try		     
            {
                ...
                PreparedStatement ps=con.prepareStatement("update customer set name=?,address=?,phone=? where email=?");
                ps.setString(1,name);
                ...
                {
                    ans=2;
                    message=new String("something is wrong!");
                }
            }
            catch(Exception e1)
            {
            ...
            <div class="header-top-right" >
                ...
                <div class="signin">
                    ...
                    <div id="small-dialog2" class="mfp-hide">
                        ...
                        <div class="help-grids">
                            ...
                            <div class="help-button-bottom">
                                <p><a href="boughtitem.jsp" class="play-icon popup-with-zoom-anim">View Items bought</a></p>
                            </div>
                            <div class="help-button-bottom">
                    ...
                    <div id="small-dialog3" class="mfp-hide">
                        ...
                        <div class="signup">
                            <form id="register" method="post" action="updatedetail.jsp">
                                ...
                                address=(String)session.getAttribute("addresskey");
                ...
                <div class="signin">
                    ...
                    <div id="small-dialog" class="mfp-hide">
                        ...
                        <div class="signup">
                            <form method="post" action="updatedetail.jsp">
                                <input name="password" type="password" placeholder="Old Password" required="required" pattern=".{6,}" title="Type yout old password" autocomplete="off" />
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <%
            if(ans==1)
            {
                ...
                out.println("<p>your data have been successfully updated.<br><a href=\"index1.jsp\"> Home</a> page is waiting for you.</p>");
                    out.println("</div>");
                    out.println("</div>");
            }
            else if(ans==3)
            {
                out.println("<h3>Updation Failed</h3>");
                    out.println("<div class=\"feedback-grids\">");
                    out.println("<div class=\"feedback-grid\">");                
                    out.println("<p>It seems "+message+".<br> Please try again Later.</p>");
                    out.println("</div>");
                    out.println("</div>");
            }else{
            out.println("<h3>Updation Failed</h3>");
                    out.println("<div class=\"feedback-grids\">");
                    out.println("<div class=\"feedback-grid\">");                
                    out.println("<p>It seems "+message+".<br> Please try again with Later.</p>");
                    out.println("</div>");
                    out.println("</div>");
            }
                    %>
