<%
        ...
        if(email!=null &&  password!=null)
        {
            try		     
            {
                ...
                {
                    ans=1;
                    String name=rs.getString(1),address=rs.getString(2),phone=rs.getString(5),bought=rs.getString(7),kart=rs.getString(6);
                    ...
                    session.setAttribute("boughtkey",bought);
                    String current=(String)session.getAttribute("currentkey");
                     
                    if(current!=null && kart!=null)
                    {
                        current=new String(current+kart);
                        kart=new String(current);
                    }
                    else if(current==null && kart!=null)
                    {
                         current=new String(kart);
                    }
                    else if(kart==null && current!=null)
                        kart=new String(current);
...
<body>
                    ...
                    <!-- POP UP BOX ****************-->
                                                                        <div id="small-dialog" class="mfp-hide">
                                                                            ...
                                                                            <div class="social-sits">
                                                                                ...
                                                                                <div class="signup">
                                                                                    <form onsubmit="return validlogin(this)" method="post" action="login.jsp">
                                                                                                <input id="email" type="text" class="email" placeholder="Enter email" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?"/>
                                                                                                <input id="password" type="password" placeholder="Password" required="required" pattern=".{6,}" title="Minimum 6 characters required" autocomplete="off" />
	...
	<div class="drop-navigation drop-navigation" id="menuwrapper">
            ...
            <div class="side-bottom">
                ...
                <div class="copyright">
                    <p>Copyright © 2015 deMokart. All Rights Reserved | Design by <a href="http://rajeev_ranjan.com/">rajeev_ranjan</a></p>
                </div>
            </div>
        </div>
    </div>
