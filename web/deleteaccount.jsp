...
<%
    ...
    %>
<%
    String password=request.getParameter("password"),message=null;
    Connection con=null;
    ...
    try
    {
        ...
        if(rs.getString(1).equals(password))
        {
            ...
            ps.setString(1,email);
            ps.execute();
            String name=null,phone=null,address=null,kart=null,bought=null,current=null;  
            email=null;
            password=null;
...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <%
    out.println("<h3>Process Failed</h3>");
    out.println("<div class=\"feedback-grids\">");
    out.println("<div class=\"feedback-grid\">");                
    out.println("<p>It seems "+message+".<br></p>");
    out.println("<div class=\"button-bottom\">");
    out.println("<p><a href=\"index1.jsp\">Click Here</a> to go to home page.<br> in case<a href=\"#small-dialog\" class=\"play-icon popup-with-zoom-anim\">Forgot Password?</a></p>");
    out.println("</div>");
    out.println("</div>");
    out.println("</div>");
