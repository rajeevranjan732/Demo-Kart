    ...
    ResultSet rs=null;
        if(oldpassword!=null &&  password!=null)
        {
            try		     
            {
                ...
                {
                    ans=2;
                    message=new String("you have entered wrong password!");
                }
            }
            catch(Exception e1)
            {
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <%
            ...
            out.println("<h3>Updation Failed</h3>");
                    out.println("<div class=\"feedback-grids\">");
                    out.println("<div class=\"feedback-grid\">");                
                    out.println("<p>It seems something is wrong contact admin ofr the problem.<br> Please try again with Later.</p>");
                    out.println("</div>");
                    out.println("</div>");
            }
                    %>
